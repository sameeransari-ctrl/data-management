    ...
    ! function(NioApp, $) {
        ...
        var salesStatistics = {
            ...
            datasets: [{
                ...
                data: [3710, 4820, 4810, 5480, 5300, 5670, 6660, 4830, 5590, 5730, 4790, 4950, 5100, 5800,
                    5950, 5850, 5950, 4450, 4900, 8000, 7200, 7250, 7900, 8950, 6300, 7200, 7250, 7650,
                    6950, 4750
                ]
            }, {
                ...
                dash: [5],
                background: "transparent",
                data: [110, 220, 810, 480, 600, 670, 660, 830, 590, 730, 790, 950, 100, 800, 950, 850, 950,
    ...
    $(window).on('load resize', function () {
        ...
        google.charts.setOnLoadCallback(drawRegionsMap);
           ...
           function drawRegionsMap() {
            var url = route('client.dashboard.mapData');
            $.ajax({
                type: "GET",
                url: url,
                dataType: 'json',
