let datas = {
    ...
    exportCsv: function () {
        $(document).on('click', '.exportCsv', function () {
            ...
            designation.forEach(function (val) {
                designationQuery += '&designation[]=' + encodeURIComponent(val);
            });

            let companiesDomainQuery = '';
            companiesDomain.forEach(function (val) {
                companiesDomainQuery += '&company_websites[]=' + encodeURIComponent(val);
            });

            var searchByRecord = '?status=' + searchStatus + '&search=' + searchData + designationQuery + companiesDomainQuery + '&export=export';
