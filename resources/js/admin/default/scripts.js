    ...
    if ($(elm).exists()) {
      $(elm).each(function () {
        ...
        var dom_normal =
          ...
          btn +
          'l>>>><"datatable-wrap my-3 table-responsive"t><"row align-items-center"<"col-7 col-sm-12 col-md-9"p><"col-5 col-sm-12 col-md-3 text-start text-md-end"i>>';
        var dom_separate =
          '<"row justify-between g-2' +
          btn_cls +
          '"<"col-7 col-sm-4 text-start"f><"col-5 col-sm-8 text-end"<"datatable-filter"<"d-flex justify-content-end g-2"' +
          btn +
          'l>>>><"my-3 table-responsive"t><"row align-items-center g-2"<"col-7 col-sm-12 col-md-9"p><"col-5 col-sm-12 col-md-3 text-start text-md-end"i>>';
