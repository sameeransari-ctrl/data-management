                    ...
                    <li class="dropdown user-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-end">
                            ...
                            <div class="dropdown-inner">
                                <ul class="link-list">
                                    <li>
                                        <a href="{{route('admin.profile.index')}}"><em class="icon ni ni-user-alt"></em><span>{{ __('labels.profile') }}</span></a>
                                    </li>
                                    <li>
                                        <a href="{{route('admin.change-user-password')}}"><em class="icon ni ni-lock-alt"></em><span>{{ __('labels.change_password') }}</span></a>
                                    </li>
                            ...
                            <div class="dropdown-inner">
                                <ul class="link-list">
                                    <li><a href="{{route('admin.logout')}}"><em class="icon ni ni-signout"></em><span>{{ __('labels.sign_out') }}</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </li>
