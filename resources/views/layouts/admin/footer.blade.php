        ...
        <div class="modal-content">
            ...
            <div class="modal-body modal-body-md">
                ...
                <form action="{{route('admin.change-password')}}" id="changePasswordForm" method="POST">
                    ...
                    {!! JsValidator::formRequest('App\Http\Requests\Admin\ChangePasswordRequest','#changePasswordForm') !!}
                </form>
                {!! returnScriptWithNonce(asset_path('assets/js/admin/auth/change-password.js')) !!}
            </div>
        </div>
    </div>
</div>
