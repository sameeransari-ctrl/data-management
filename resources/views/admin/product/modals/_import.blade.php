<form id="importProductForm" action="{{ route('admin.product.import')}}" method="POST">
    {{csrf_field()}}
...
{!! JsValidator::formRequest('App\Http\Requests\Admin\ImportProductRequest','#importProductForm') !!}
