<form id="addQuestionForm" action="{{ route('admin.product.store-question')}}" method="POST">
{{csrf_field()}}
<div class="row g-3">
...
{!! JsValidator::formRequest('App\Http\Requests\Admin\AddQuestionRequest','#addQuestionForm') !!}
