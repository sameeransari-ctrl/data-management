<form id="editQuestionForm" action="{{route('admin.product.update-question', $productQuestion[0]['id'])}}" method="POST">
   {{ method_field('put') }}
   <div class="row g-3">
...
{!! JsValidator::formRequest('App\Http\Requests\Admin\EditQuestionRequest','#editQuestionForm') !!}
