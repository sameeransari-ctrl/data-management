...
@section('title', __('labels.product'))
@section('content')
<!-- content @s -->
                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">{{__('labels.product')}}</h3>
                            <nav>
                                <ul class="breadcrumb breadcrumb-arrow">
                                    <li class="breadcrumb-item">
                                        <a href="{{route('admin.dashboard')}}">{{__('labels.dashboard')}}</a>
                                    </li>
                                    <li class="breadcrumb-item active">{{__('labels.product')}}</li>
                                </ul>
                            </nav>
                            <!-- breadcrumb @e -->
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <form id='resetFormFilter'>
                                        <ul class="nk-block-tools g-2 flex-wrap">
                                            ...
                                            <li><a href="{{route('admin.product.create')}}" class="btn btn-primary" ><em class="icon ni ni-plus"></em><span>{{__('labels.add_product')}}</span></a></li>
                                            @endcan
                                        </ul>
                                    </form>
                                </div>
                            ...
                            <table class="datatable-init nowrap table" id="product_table" aria-describedby="product table">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="client_name">{{__('labels.client_name')}}</th>
...
<script nonce="{{csp_nonce('script')}}">
    var canEdit = "{{auth()->user()->can('admin.product.edit')}}";
    var canView = "{{auth()->user()->can('admin.product.show')}}";
</script>
{!! returnScriptWithNonce(asset_path('assets/js/admin/product/index.js')) !!}
@endpush
