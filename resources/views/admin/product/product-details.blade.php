                        ...
                        <div class="nk-block-head-content">
                            ...
                            <nav>
                                <ul class="breadcrumb breadcrumb-pipe">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin.product.index')}}">{{__('labels.product')}}</a>
                                    </li>
                    ...
                    <div class="card">
                        <div class="card-inner">
                            ...
                            <div class="text-end mt-lg-4 mt-2">
                                <a href="{{route('admin.product.edit', $product->id)}}" type="button" class="btn btn btn-light">{{__('labels.edit')}}</a>
                            </div>
                            @endcan
                        </div>
                    </div>
...
@push('scripts')
{!! returnScriptWithNonce(asset_path('assets/js/admin/product/raty.min.js')) !!}
{!! returnScriptWithNonce(asset_path('assets/js/admin/product/product-details.js')) !!}
