...
@section('title', __('labels.edit_product'))
@section('content')
<!-- content @s -->
                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">{{__('labels.edit_product')}}</h3>
                            <nav>
                                <ul class="breadcrumb breadcrumb-arrow">
                                    ...
                                    <li class="breadcrumb-item active">{{__('labels.edit_product')}}</li>
                                </ul>
                            </nav><!-- breadcrumb @e -->
                           ...
                           <div class="wide-lg-fix">
                              <div class="stepForm mx-auto">
                                 <fieldset>
                                    ...
                                    <form id="editProductForm" action="{{ route('admin.product.update', $id)}}" method="PUT">
                                       {{csrf_field()}}
                                          ...
                                          <div class="row g-sm-3 g-2">
                                                ...
                                                <div class="form-group ">
                                                   ...
                                                   <div class="form-control-wrap">
                                                      <div class="input-group copy-link">
                                                         <input type="text" class="form-control shadow-none copy-link-input" placeholder="{{__('labels.enter')}} {{__('labels.url_link')}}" value="{{$product->image_url}}" name="image_url" id="image_url">
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                   ...
                                                   <div class="form-control-wrap">
                                                      <input type="text" class="form-control shadow-none" placeholder="{{__('labels.enter')}} {{__('labels.product_name')}}" name="product_name" id="product_name" value="{{$product->product_name}}">
                                                   </div>
                                                </div>
                                             </div>
                                             <div class="col-md-6">
                                                   ...
                                                   <select class="form-select client-js-select2" data-placeholder="{{__('labels.select')}} {{__('labels.client_name')}}" aria-describedby="client_id-error" name="client_id" id="client_id">
                                                      ...
                                                      @if(!empty($clientList))
                                                         @foreach($clientList as $value)
                                                            <option @if($product->client_id == $value->id) selected @endif value="{{ $value->id }}">{{ ucwords($value->name) }}</option>
                                                         @endforeach
                                                      @endif
                                                      {{-- <option @if(is_null($product->client_id)) selected @endif value="other">{{__('labels.other')}}</option> --}}
                                                   </select>
                                                   ...
                                                   <select class="form-select js-select2" data-placeholder="{{__('labels.select')}} {{__('labels.basicUdidNo')}}" aria-describedby="basic_udid_id-error" name="basic_udid_id" id="basic_udid_id">
                                                      ...
                                                      @if(!empty($basicUdids))
                                                         @foreach($basicUdids as $basicUdid)
                                                            <option @if($product->basic_udid_id == $basicUdid->id) selected @endif value="{{ $basicUdid->id }}">{{ $basicUdid->name }}</option>
                                                         @endforeach
                                                      @endif
                                                   </select>
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                   ...
                                                   <div class="form-control-wrap">
                                                      <input type="text" class="form-control shadow-none" placeholder="{{__('labels.enter')}} {{__('labels.udi_no')}}" name="udi_number" id="udi_number" value="{{$product->udi_number}}">
                                                   </div>
                                                </div>
                                             </div>
                                             <div class="col-md-6">
                                                   ...
                                                   <select class="form-select js-select2" data-placeholder="{{__('labels.select')}} {{__('labels.class')}}" aria-describedby="class_id-error" name="class_id" id="class_id">
                                                      ...
                                                      @if(!empty($productClassList))
                                                         @foreach($productClassList as $value)
                                                            <option @if($product->class_id == $value->id) selected @endif value="{{ $value->id }}">{{ $value->name }}</option>
                                                         @endforeach
                                                      @endif
                                                   </select>
                                             ...
                                             <div class="col-md-12">
                                                <div class="form-group">
                                                   ...
                                                   <div class="form-control-wrap">
                                                      <textarea class="form-control shadow-none" placeholder="{{__('labels.enter')}} {{__('labels.product_description')}}" name="product_description" id="product_description">{{$product->product_description}}</textarea>
                                                   </div>
                                                </div>
                                             </div>
                                             {{-- <div class="col-md-6 @if(!is_null($product->client_id)) d-none @endif" id="otherClientNameSection">
                                                <div class="form-group">
                                                   <label class="form-label">{{__('labels.other')}} {{__('labels.client_name')}}</label>
                                                   <div class="form-control-wrap">
                                                      <input type="text" class="form-control shadow-none" placeholder="{{__('labels.enter')}} {{__('labels.other')}} {{__('labels.client_name')}}" name="client_name" id="client_name" value="{{$product->client_name}}">
                                                   </div>
                                                </div>
                                             </div> --}}
                                             <div class="col-md-12">
                                                <div class="form-group">
                                                   ...
                                                   <div class="form-control-wrap field_wrapper">
                                                      <div class="input-group copy-link">
                                                         <input type="text" class="form-control shadow-none copy-link-input" placeholder="{{__('labels.add_file_url')}}" value="@if(!empty($product->productFiles) && count($product->productFiles) > 0) {{$product->productFiles[0]->file_url}} @endif" name="file_url[]" aria-describedby="file_url-0-error" >
                                                         <div class="input-group-append">
                                                            <span class="input-group-text cursor-pointer copy-link-button" id="copyUrlText2"><em class="icon ni ni-link fs-14px"></em></span>
                                                         </div>
                                                         <a class="add_button addMoreBtn" data-count="{{count($product->productFiles)}}" title="{{__('labels.add_field')}}"><em class="icon ni ni-plus-sm"></em></a>
                                                      </div>
                                                      <span id="file_url-0-error" class="help-block error-help-block"></span>

                                                      @if(!empty($product->productFiles))
                                                         @foreach($product->productFiles as $key=>$pfile)
                                                            @if($key > 0)
                                                            <div class="mt-2">
                                                               <div class="input-group copy-link">
                                                                  <input type="text" class="form-control shadow-none copy-link-input" name="file_url[]" placeholder="Add File URL" value="{{$pfile->file_url}}" aria-describedby="file_url-{{$key}}-error">
                                                                  <div class="input-group-append">
                                                                     <span class="input-group-text cursor-pointer copy-link-button" id="copyUrlText2">
                                                                        <em class="icon ni ni-link fs-14px"></em>
                                                                     </span>
                                                                  </div>
                                                                  <a class="remove_button addMoreBtn" title="Add field"><em class="icon ni ni-minus-sm"></em></a>
                                                               </div>
                                                               <span id="file_url-{{$key}}-error" class="help-block error-help-block"></span>
                                                            </div>
                                                            @endif
                                                         @endforeach
                                                      @endif
                                 ...
                                 <fieldset>
                                    ...
                                    <div class="stepForm_btns d-flex justify-content-between align-items-center">
                                       ...
                                       <div class="d-flex">
                                          <a class="btn btn-light ripple-effect que-review skip me-2" id="questionForReviewSkipBtn">{{__('labels.skip')}}</a>
                                          <a class="btn btn-primary ripple-effect que-review next" data-product_id="{{$id}}" id="questionForReviewSaveNContinueBtn">{{__('labels.save_n_continue')}}</a>
                                       </div>
                                    </div>
                                 </fieldset>
                                 <fieldset>
                                    ...
                                    <div class="stepForm_btns d-flex justify-content-between align-items-center">
                                       ...
                                       <button type="button" data-product_id="{{$id}}" data-status="1" id="productFinalSubmitBtn" class="btn btn-primary ripple-effect">{{__('labels.save')}}</button>
                                       </div>
                                    </div>
                                 </fieldset>
                              </div>
...
<!-- content @e -->
{{-- step 1 validation --}}
{!! JsValidator::formRequest('App\Http\Requests\Admin\EditProductRequest','#editProductForm') !!}
...
@endsection
@push('scripts')
{!! returnScriptWithNonce(asset_path('assets/js/admin/product/edit.js')) !!}
@endpush
