        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row g-sm-3 g-2">
                    ...
                    <div class="col-sm-6">
                        <h5 class="lead-text mb-2">{{__('labels.date')}}</h5>
                        <p class="card-text text-break">{{convertDateToTz($fsnResult['created_at'], 'd M Y, h:i A') }}</p>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-6">
                        <h5 class="lead-text mb-2">{{__('labels.manufacture')}}</h5>
                        <p class="card-text text-break mb-2">{{$fsnResult['client_name'] ?? '---'}}</p>
                    </div>
                    <div class="col-12">
