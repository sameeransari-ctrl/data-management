                ...
                <div class="nk-content ">
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        <div class="brand-logo pb-4 text-center">
                            <a href="{{route('admin.forgot-password')}}" class="logo-link">
                        ...
                        <div class="card">
                            <div class="card-inner card-inner-lg">
                                ...
                                <form action="{{ route('admin.forgotPassword') }}" id="submitFrom" method="POST">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-lg btn-primary btn-block">{{__('labels.send_reset_link')}}</button>
                                    </div>
                                    {!! JsValidator::formRequest('App\Http\Requests\Admin\VerifyEmailRequest','#submitFrom') !!}
                                </form>
                                <div class="form-note-s2 text-center pt-1">
