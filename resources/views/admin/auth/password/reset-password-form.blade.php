                    ...
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        ...
                        <div class="card">
                            <div class="card-inner card-inner-lg">
                                ...
                                <form action="{{ route('admin.password.post') }}" id="add-form" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            <input type="password" class="form-control form-control-lg shadow-none" name="confirm_password" id="confirm-password" placeholder="{{__('labels.confirm_new_password')}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-lg btn-primary btn-block">{{__('labels.update')}}</button>
                                    </div>
                                    {!! JsValidator::formRequest('App\Http\Requests\Admin\ResetPasswordRequest','#add-form') !!}
                                </form>
                                <div class="form-note-s2 text-center {{-- pt-4 --}}">
                                    <a href="{{route('admin.login')}}" class=""><strong>{{__('labels.return_to_login')}}</strong></a>
                                </div>
                            </div>
                        </div>
                    </div>
