...
<div class="nk-content ">
                        ...
                        <div class="nk-block-head-content">
                            ...
                            <nav>
                                <ul class="breadcrumb breadcrumb-arrow">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin.user.index')}}">{{__('labels.user_management')}}</a></li>
                            ...
                            <div class="toggle-wrap nk-block-tools-toggle">
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <ul class="nk-block-tools g-3">
                                        <li>
                                            <a href="{{route('admin.user.index')}}" class="btn btn-outline-light bg-white d-none d-sm-inline-flex">
                                                <em class="icon ni ni-arrow-left"></em>
                                                <span>{{__('labels.back')}}</span>
                                            </a>
                                            <a href="{{route('admin.user.index')}}" class="btn btn-icon btn-outline-light bg-white d-inline-flex d-sm-none">
                                                <em class="icon ni ni-arrow-left"></em>
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="card-inner">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-6">
                                                ...
                                                <span>{{ucwords($user->user_type.' User')}}</span>
                                            </div>
                                            <div class="col-6">
    ...
    @endsection
    @push('scripts')
    {!! returnScriptWithNonce(asset_path('assets/js/admin/user/user-details.js')) !!}
    @endpush
