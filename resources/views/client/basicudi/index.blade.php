...
<div class="nk-content">
                            ...
                            <div class="nk-block-head-content">
                                ...
                                <nav>
                                    <ul class="breadcrumb breadcrumb-arrow">
                                        ...
                                        <li class="breadcrumb-item active">{{__('labels.udi_list')}}</li>
                                    </ul>
                                </nav>
                                ...
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    ...
                                    <form id='resetFormFilter'>
                                        <ul class="nk-block-tools gx-3 gy-2 flex-wrap">
                                            ...
                                            <li><a download href="{{getImageUrl('basic-udi-sample.xlsx', '', false)}}" class="btn btn-white btn-outline-light"><em class="icon ni ni-download-cloud"></em><span>{{__('labels.sample_file_download')}}</span></a></li>
    ...
    @endsection
    @push('scripts')
    {!! returnScriptWithNonce(asset_path('assets/js/client/basicudi/index.js')) !!}
    @endpush
