                        ...
                        <div class="nk-block-head-content">
                            ...
                            <nav>
                                <ul class="breadcrumb breadcrumb-arrow">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="{{route('client.product.index')}}">{{__('labels.product_management')}}</a>
                                    </li>
                           ...
                           <div class="wide-lg-fix">
                              <div class="stepForm mx-auto">
                                 <fieldset>
                                    ...
                                    <form id="editProductForm" action="{{ route('client.product.update', $id)}}" method="PUT">
                                       {{csrf_field()}}
                                 ...
                                 <fieldset>
                                    ...
                                    <div class="stepForm_btns d-flex justify-content-between align-items-center">
                                       ...
                                       <div class="d-flex">
                                       <a href="{{route('client.product.index')}}" class="btn btn-light ripple-effect me-2" id="productCancelBtn">{{__('labels.skip')}}</a>
...
<!-- content @e -->
{{-- step 1 validation --}}
{!! JsValidator::formRequest('App\Http\Requests\Client\EditProductRequest','#editProductForm') !!}
...
@endsection
@push('scripts')
{!! returnScriptWithNonce(asset_path('assets/js/client/product/edit.js')) !!}
@endpush
