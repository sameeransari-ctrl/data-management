                              ...
                              <div class="wide-lg-fix">
                                 <div class="stepForm mx-auto">
                                    <fieldset>
                                       ...
                                       <form id="addProductForm" action="{{ route('client.product.store')}}" method="POST">
                                          {{csrf_field()}}
...
<!-- content @e -->
{{-- step 1 validation --}}
{!! JsValidator::formRequest('App\Http\Requests\Client\AddProductRequest','#addProductForm') !!}
...
@push('scripts')
{!! returnScriptWithNonce(asset_path('assets/js/client/product/add.js')) !!}
@endpush
