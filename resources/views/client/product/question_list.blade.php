    ...
    @if ($question['answer_type']==1)
        <div class="col-md-12" id="questionId_{{ $question['id'] }}">
            <div class="box">
                ...
                <div class="action">
                    <a class="editQuestionModal" data-question_type="{{$question['question_type']}}" data-question_id="{{ $question['id'] }}"><em class="ni ni-edit-alt"></em></a>
                    ...
                    <a class="removeData" data-question_id="{{ $question['id'] }}"><em class="ni ni-cross"></em></a>
                </div>
            </div>
        </div>
    @endif
